...
/*
    Specifies the alien that continually swoops at the player
 */
class AlienDiverSpec extends ObjectSpec {
    ...
    private static final PointF relativeScale = new PointF(20f, 18f);
    private static final String[] components = new String[]{"StdGraphicsComponent", "AlienDiverMovementComponent", "AlienVerticalSpawnComponent"};
