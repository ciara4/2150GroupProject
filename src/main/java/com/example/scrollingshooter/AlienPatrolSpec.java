...
/*
    Specifies the Patrolling alien
 */
class AlienPatrolSpec extends ObjectSpec {
    ...
    private static final String[] components = new String[]{"StdGraphicsComponent", "AlienPatrolMovementComponent", "AlienHorizontalSpawnComponent"};
