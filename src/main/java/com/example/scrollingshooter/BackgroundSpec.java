...
/*
    Specifies the background object
 */
class BackgroundSpec extends ObjectSpec {
    ...
    private static final String[] components = new String[]{"BackgroundGraphicsComponent", "BackgroundMovementComponent", "BackgroundSpawnComponent"};
